...
const CoursesHeader = () => {
  return (
    <>
        <header className='w-[1440px] h-[300px] border-b-2 border-gray flex ml-12'>
            <div className="w-[650px] h-[300px]  p-24">
                <h2 className="text-4xl font-semibold">Online Courses on Design and Development</h2>
            </div>
            <div className="w-[720px] h-[300px]  pt-24">
