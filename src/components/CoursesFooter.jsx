...
const CoursesFooter = () => {
  return (
    <>
        <div className='w-[1515px] h-[400px] mt-32  bg-white flex justify-center items-center'>
            ...
            <p className="text-xl text-center mt-[-20px]">© 2023 Skillbridge. All rights reserved.</p>
    </>
  )
}
